...
// Removed backend integration and useMummy hook.
// Using dummy data for demonstration:
const dummyMummyData = {
  preferred_kids_count: "one_to_five",
  preferred_age_group: "one_to_three",
  Mummy_services: ["childcare"],
  education_level: "bachelor",
  years_of_experience: 5,
  contact_persons: [
    { name: "Alice", phone: "123-456-7890", relationship: "Mother" },
    { name: "Bob", phone: "987-654-3210", relationship: "Guardian" },
  ],
};
...
const SingleMummyPage = () => {
  ...
  const MummyData = dummyMummyData;
              ...
              <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-4 border-b border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-barlow text-sm">
                    {mapKidsCount(MummyData.preferred_kids_count)}
                  </span>
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-4 border-b border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="font-barlow text-sm">
                    {mapAgeGroup(MummyData.preferred_age_group)}
                  </span>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="border p-2 border-gray-200 rounded-lg shadow-sm">
              ...
              <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-4">
                ...
                <span className="font-barlow font-semibold">
                  {MummyData.years_of_experience !== null
                    ? MummyData.years_of_experience
                    : "N/A"}{" "}
                  years
                </span>
              </div>
