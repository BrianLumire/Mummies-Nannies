// /components/Mummies/TableControlsMummy.tsx
"use client";
import React, { useState, useRef, useEffect } from "react";
import Image from "next/image";
import { FilterCriteria } from "@/utils/filterData";

interface TableControlsMummyProps {
  searchTerm: string;
...
const TableControlsMummy: React.FC<TableControlsMummyProps> = ({
  searchTerm,
  onSearchChange,
  onFilterClick,
  onSortClick,
  ...
  // Define filter options for mummies (e.g. by location)
  const filterableOptions: { [key: string]: string[] } = {
    "Active Mummies": ["Molo, Nakuru", "Other Location"],
    "Suspended Mummies": ["Molo, Nakuru", "Other Location"],
  };

  // Define sortable columns for mummies
    ...
    <div className="flex items-center gap-2  ">
      ...
      <div className="relative" ref={filterRef}>
        ...
        {isFilterDropdownOpen && (
          <div className="absolute bg-[#FAFAFA] border border-gray-300 rounded-lg mt-2 py-2 w-36 shadow-lg z-10">
...
export default TableControlsMummy;
